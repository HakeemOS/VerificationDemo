...
HD_PWD='C:/Users/squid/OneDrive/Documents/Vivado/2024/VerificationDemo/VerificationDemo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log invLED_s.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source invLED_s.tcl
